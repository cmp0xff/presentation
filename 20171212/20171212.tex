...
\item Fixing $\nu/\sigma<1$, the asymptotic expansion is not oscillatory, but 
exponential; hence no WKB approximation applies.

\item The conclusions also work for $\rfun{\mathrm{F}_{\ii\nu}}{\sigma}$
